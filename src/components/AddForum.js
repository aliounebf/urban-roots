  ...
  <div className="mt-3 text-center text-4xl font-bold">Ajouter un forum</div>
      <form className='p-8' onSubmit={handleSubmit}>
        ...
        <div className="flex gap-4">
          <input
            type="text"
            className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-white focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" 
