    ...
    <div className='px-4 py-4'>
      ...
      <div className="hidden md:flex space-x-4 flex justify-between items-center">
        ...
        <nav className="flex space-x-4">
          <a href="/map" className="text-black hover:text-[#186321] transition">Map</a>
          ...
          <a href="/forums" className="text-black hover:text-[#186321] transition">Forums</a>
          <a href="/guides" className="text-black hover:text-[#186321] transition">Guides</a>
          <a href="/innovations" className="text-black hover:text-[#186321] transition">Innovation</a>
          <a href="/events" className="text-black hover:text-[#186321] transition">Evènement</a>
          <a href="/resource" className="text-black hover:text-[#186321] transition">Ressource</a>
        </nav>
