        ...
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">Urban Root</tspan>
                    </text>
                  </g>
                </g>
              </svg>
            ...
            <p className="text-justify">
             ...
             Nunc tincidunt nunc erat, in ornare leo rutrum a. 
             Vivamus ultrices suscipit malesuada. Donec non lacus nulla. 
            </p>
          </div>

          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Navigations</h2>
            </div>
            <ul className="leading-8">  
            <li>
            <a href='/home' className="px-4 mb-4 text-white hover:text-lime-500 transition">
            Home
            </a>
            </li>
            <li>                
            <a href="/map" className="px-4 text-white hover:text-lime-500 transition">Map</a>
            </li>
            <li>
            <a href="/forums" className="px-4 text-white hover:text-lime-500 transition">Forums</a>
            </li>
            <li>
            <a href="/guides" className="px-4 text-white hover:text-lime-500 transition">Guides</a>
            </li>
            <li>
            <a href="/innovations" className="px-4 text-white hover:text-lime-500 transition">Innovations</a>
            </li>
            <li>
            <a href="/events" className="text-white px-4 py-4 hover:text-lime-500 transition">Evenement</a>
            </li>
            <li>
            <a href="/resource" className="text-white px-4 py-2  hover:text-lime-500 transition">Ressource</a>
            </li>           
            </ul>
          </div>
          {/* <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              ...
              <li><a href="#" className="hover:text-blue-400">What Is Forum</a></li>
              <li><a href="#" className="hover:text-blue-400">How Can Help Your Productivity?</a></li>
      ...
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2024
            <script>new Date().getFullYear()  2024 && document.write("- " + new Date().getFullYear())</script>- 2024
          </div>
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with ❤️ by Alioune Badara Fall.
          </div>
        </div>
      </div>
    </div>
